...
2. 填寫資料
   ...
   ![綠界結帳 — 訂購人資訊填寫畫面，Email 填入要使用的 Gmail 帳號](/images/結帳/綠界_訂購人資訊.jpg)
   Email 請填入==要使用的人的 Gmail 帳號==
   以便透過 Gmail 發送 email 分享「可建立副本」的連結
   ![綠界結帳 — 訂單備註填寫說明，聯繫 Email 與 Google 帳號不同時需填入使用者帳號](/images/結帳/綠界_訂單備註.jpg)
   若聯繫的 Email 與使用人的 Google 帳號不同時，請將使用人的 Google 帳號填寫在訂單備註

3. 可選擇付款方式 ex.信用卡

![綠界信用卡結帳流程示範 — 選擇信用卡付款並完成結帳步驟](/images/結帳/綠界_信用卡.webp)
...
4. 告知購買品項 > 依版本填入備註 - Gmail帳號 ( ==要使用的人的 Gmail 帳號== )
   例 : `kevin@gmail.com` 要購入 台股訂閱版 → 則填入「台股訂閱版kevin」
